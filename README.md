...
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-apt_autostart/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-apt_autostart/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-apt_autostart.svg)](https://github.com/buluma/ansible-role-apt_autostart/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-apt_autostart.svg)](https://github.com/buluma/ansible-role-apt_autostart/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-apt_autostart.svg)](https://github.com/buluma/ansible-role-apt_autostart/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/apt_autostart)](https://galaxy.ansible.com/ui/standalone/roles/buluma/apt_autostart/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-apt_autostart/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-apt_autostart/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-apt_autostart
